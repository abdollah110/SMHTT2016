...
//    if (tes==19) nbhist=6;
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        //AM
//        if (sample=="embedded" ) cout<<"####AM####\t genDR_2= "<< genDR_2<<"\n" ;
...
//        
        ...
        //	bool is_bveto=(sample!="data_obs" or nbtag==0);  AM
        bool is_bveto=((sample!="data_obs" and sample!="embedded" )or nbtag==0);
