...
//AM
        ...
        if (is_0jet && mt<50){
            if (signalRegion && q_1*q_2<0){
                ...
                plotFill("Lep_pt_0jet",mymu.Pt(),60,0,300,Total_Embed_Weight);
                plotFill("Lep_eta_0jet",mymu.Eta(),50,-2.5,2.5,Total_Embed_Weight);
                plotFill("Lep_iso_0jet",iso_1,40,0,2,Total_Embed_Weight);
                
                plotFill("Tau_pt_0jet",mytau.Pt(),60,0,300,Total_Embed_Weight);
                plotFill("Tau_eta_0jet",mytau.Eta(),50,-2.5,2.5,Total_Embed_Weight);
                
                plotFill("Higgs_visMass_0jet",(mymu+mytau).M(),100,0,500,Total_Embed_Weight);
                plotFill("Higgs_pt_0jet",(mymu+mytau).Pt(),60,0,300,Total_Embed_Weight);
                
                plotFill("mjj",mjj,20,0,1000,Total_Embed_Weight);
                plotFill("jpt_1",jpt_1,50,0,500,Total_Embed_Weight);
                plotFill("jpt_2",jpt_2,50,0,500,Total_Embed_Weight);
                
                plotFill("mt",mt,20,0,100,Total_Embed_Weight);
