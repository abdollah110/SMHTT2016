...
int main(int argc, char** argv) {
    ...
    PyObject* fitFunctions =  PyImport_ImportModule((char *)"FitFunctions_Emb");
...
//          cout << "sf_trg1 = "<<sf_trg1<< "   gen_match_1= "<< gen_match_1 <<  "  sf_trg_RR=" << PyFloat_AsDouble(trgSF) <<"\n";
...
//          cout << "sf_trg2 = "<<sf_trg2<< "   gen_match_2= "<< gen_match_2 <<  "  sf_trg_RR" << PyFloat_AsDouble(trgSF) <<"\n";
...
//	      h_0jet->Fill(var,Total_Embed_Weight);
	  ...
	  if (is_boosted && signalRegion && charge1*charge2<0){
	    h1_OS[k]->Fill(var,Total_Embed_Weight);
//	    if (tes==0){
...
//	    }
	  ...
	  if (is_VBF && signalRegion && charge1*charge2<0) {
	    h2_OS[k]->Fill(var,Total_Embed_Weight);
//	    if (tes==0){
